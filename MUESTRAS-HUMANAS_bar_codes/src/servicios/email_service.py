            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f5f5f5; padding: 30px 10px;">
                <tr>
                    <td align="center">
                        ...
                        <!-- Card principal - Fondo BLANCO minimalista -->
                                        ...
                                        <tr>
                                            <td style="padding: 16px 18px;">
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td style="color: #555555; font-size: 12px; padding: 5px 0;">
                                                            <code style="background: #f0f0f0; color: #728C31; padding: 3px 8px; border-radius: 4px; font-family: 'Courier New', monospace; font-size: 11px; font-weight: 600;">{{ID}}_alicuota_4.png</code>
                                                            <span style="margin-left: 8px; color: #666666;">→ Alícuota 4</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="color: #555555; font-size: 12px; padding: 5px 0;">
                                                            <code style="background: #f0f0f0; color: #728C31; padding: 3px 8px; border-radius: 4px; font-family: 'Courier New', monospace; font-size: 11px; font-weight: 600;">{{ID}}_alicuota_5.png</code>
                                                            <span style="margin-left: 8px; color: #666666;">→ Alícuota 5</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="color: #555555; font-size: 12px; padding: 5px 0;">
                                                            <code style="background: #f0f0f0; color: #728C31; padding: 3px 8px; border-radius: 4px; font-family: 'Courier New', monospace; font-size: 11px; font-weight: 600;">{{ID}}_alicuota_6.png</code>
                                                            <span style="margin-left: 8px; color: #666666;">→ Alícuota 6</span>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
